...
from src.config_defaults import (
    ...
    DEFAULT_GOOGLE_API_KEY, DEFAULT_GOOGLE_SEARCH_ENGINE_ID,
    DEFAULT_OLLAMA_HTTP_URL, DEFAULT_BROWSER_PATH,
    DEFAULT_SKILLSMP_API_KEY, DEFAULT_GITHUB_TOKEN,
    DEFAULT_UNSPLASH_ACCESS_KEY, DEFAULT_PEXELS_API_KEY,
    DEFAULT_IMAGE_ANALYSIS_MODEL, DEFAULT_IMAGE_ANALYSIS_API_KEY, DEFAULT_IMAGE_ANALYSIS_BASE_URL
)
...
GOOGLE_SEARCH_ENGINE_ID = get_config('GOOGLE_SEARCH_ENGINE_ID')
OLLAMA_HTTP_URL = get_config('OLLAMA_HTTP_URL')
BROWSER_PATH = get_config('BROWSER_PATH')
SKILLSMP_API_KEY = get_config('SKILLSMP_API_KEY')
GITHUB_TOKEN = get_config('GITHUB_TOKEN')
UNSPLASH_ACCESS_KEY = get_config('UNSPLASH_ACCESS_KEY')
PEXELS_API_KEY = get_config('PEXELS_API_KEY')
IMAGE_ANALYSIS_MODEL = get_config('IMAGE_ANALYSIS_MODEL')
IMAGE_ANALYSIS_API_KEY = get_config('IMAGE_ANALYSIS_API_KEY')
IMAGE_ANALYSIS_BASE_URL = get_config('IMAGE_ANALYSIS_BASE_URL')
